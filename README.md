...
sua empresa. Vamos ajudá-lo. Iremos começar construindo o banco de dados.
 ...
 ### Com base no estudo de caso acima, foi construido um modelo conceitual para desenvolvimetno de um banco de dados que atenda a Casa Oliveira
